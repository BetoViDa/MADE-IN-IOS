    ...
    struct Result: Decodable, Identifiable {
        ...
        var answers: [Answer] {
            do {
                ...
                let correct = [Answer(text: try AttributedString(markdown: answer), isCorrect: true)]
                let incorrects = try options.map { answer in Answer(text: try AttributedString(markdown: answer), isCorrect: false)
                }
